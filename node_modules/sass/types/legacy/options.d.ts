...
export interface LegacySharedOptions<sync extends 'sync' | 'async'> {
   ...
   *
   * ```sh
   * $ SASS_PATH=node_modules/bootstrap/dist/css sass style.css style.css
   * ```
   *
   * @category Input
...
export interface LegacyFileOptions<sync extends 'sync' | 'async'>
   ...
   * is `.css`, it will be parsed as SCSS; if it’s `.sass`, it will be parsed
   ...
   *
   * ```js
   * sass.renderSync({file: "style.css"});
   * ```
   *
   * @category Input
