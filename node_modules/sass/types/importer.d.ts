 ...
 * - {@link canonicalize} returns `new URL("db:foo/bar/baz/_index.css")`.
...
export interface Importer<sync extends 'sync' | 'async' = 'sync' | 'async'> {
   ...
   *   URL's basename, and by adding the extensions `.sass` and `.css` if the
   ...
   *   - `foo/bar/_baz.css`
   *
   *   If the URL was `foo/bar/baz.css`, the importer would just look for:
   *   - `foo/bar/baz.css`
   *   - `foo/bar/_baz.css`
   *
   ...
   *   - `foo/bar/baz/index.css`
   *   - `foo/bar/baz/_index.sass`
   *   - `foo/bar/baz/_index.css`
   *
   ...
   *   stylesheet's canonical URL `db:foo/bar/baz/_index.css` to get
   *   `db:foo/bar/baz/mixins`.
   * - It calls {@link canonicalize} with `"db:foo/bar/baz/mixins"`.
   * - {@link canonicalize} returns `new URL("db:foo/bar/baz/_mixins.css")`.
   *
 ...
 * file at `node_modules/uicomponents/src/scss/index.css`.
 *
 ...
 *     },
 *     "./colors.css": {
 *       "sass": "./src/scss/_colors.css",
 *     },
 *     "./theme/*.css": {
 *       "sass": "./src/scss/theme/*.css",
 *     },
 *   }
 * }
 * ```
 ...
 * `_index.css` exists in the package root of `uicomponents`, a user can import
 ...
 * example, if the file `src/sass/_colors.css` exists in the `uicomponents`
